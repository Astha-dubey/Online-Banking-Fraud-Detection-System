...
SECRET_KEY = ')f&#@lw=gnaf0mjz$j$+b7woygkb#m@yhdj8ed8ev4!6971*q1'
...
Need to uncomment please make sure
'''

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'fraud_detection',          # Replace with your MySQL database name
        'USER': 'root',          # Replace with your MySQL database user
        'PASSWORD': 'root@123',  # Replace with your MySQL database password
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aastha042003@gmail.com'
EMAIL_HOST_PASSWORD = 'frlo qstz iuzq ggcg'  #change
